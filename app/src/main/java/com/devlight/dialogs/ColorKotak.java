...
public class ColorKotak extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public ColorKotak(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ColorKotak(Context context, AttributeSet attrs, int defStyle) {
